...
const SignUpForm = () => {
  ...
  // Example franchise options—update these as needed.
  const franchiseOptions = ["Franchise 1", "Franchise 2", "Franchise 3"];
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      const dataToSend = {
        ...
        //  franchise: formData.franchise, // New field sent to API
        gst: formData.gst,
      };
      setIsLoading(true);
      try {
            ...
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3">
                  ...
                  {errors.policy && (
                    <small className="text-danger">{errors.policy}</small>
                  )}
                </Form.Group>
